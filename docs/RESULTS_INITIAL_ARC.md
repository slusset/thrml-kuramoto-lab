# Initial results snapshot — oscillators to samplers

This is the original six-finding results summary. It is preserved as a
historical snapshot because later experiments refined or bounded several of
its claims. See the repository `RESULTS.md` for the current integrated result.
