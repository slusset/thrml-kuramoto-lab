...
This file preserves the chronological research narrative that originally lived
in the project README. It records hypotheses, failed predictions, protocol
changes, numerical findings, and evolving interpretations in the order they
occurred. It is an archive, not the current project summary.

For the current framing, see the repository `README.md`, `RESULTS.md`, and
`docs/CONCEPTS.md`.

## Original lab narrative
